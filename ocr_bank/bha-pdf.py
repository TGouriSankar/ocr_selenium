...
def main(pdf_path):
    output_folder = f'/media/player/karna1/HYD/{os.path.splitext(os.path.basename(pdf_path))[0]}'
...
if __name__ == "__main__":
    pdf_path = '/home/player/Bank Statements/andhra-bank-statement_compress.pdf'  # Specify your PDF path here
    main(pdf_path)
